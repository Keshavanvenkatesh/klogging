...
#             return sum_
#         else:
#             print("not a square matrix - trace")
...
# Other Functions:
#   obj.det()                     -> Determinant of matrix
#   obj.transpose(type)           -> Transpose matrix (type='modify' or 'new')
#   obj.inverse()                 -> Inverse of matrix
#   obj.adjoint()                 -> Adjoint of matrix
#   obj.order()                   -> Order of matrix
